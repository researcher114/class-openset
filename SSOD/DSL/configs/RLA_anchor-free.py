...
data_root = '/home/DSL-open/data/semivoc/'
...
data = dict(
    ...
    #    img_prefix='//voc/VOCdevkit/VOC2007/JPEGImages/',
    #    pipeline=test_pipeline),
    ...
    #     img_prefix='//voc/VOCdevkit/VOC2012/JPEGImages/',
    #     pipeline=test_pipeline)
    test=dict(
        type='VOCDataset',
        ann_file='/home/DSL-open/ori_data/VOCdevkit/VOC2007/voc_coco_ann/ImageSets/Main/voc_coco_20000_test.txt',
        img_prefix='/home/DSL-open/ori_data/VOCdevkit/VOC2007/',
        pipeline=test_pipeline)
)
# learning policy
